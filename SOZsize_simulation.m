...
% Procedure:
%    1. Creates a simulated SOZ in 1, 2, or 3D. 
...
%    3. Calculates volume of the spheree (true SOZ) and the convex hull
%    (assumed SOZ based on within-sphere electrodes). 
% Can do this for different recording "dimensions" (1, 2, or 3) to simulate
% single depth, grid, SEEG/multiple depths respectively.
